...
public class RainbowActionsManager {
    ...
    public static abstract class BaseAction {
         ...
         * @return
         */
        protected abstract RainbowActionsManager.BaseAction.ConcurrencyType getConcurrencyType();
        ...
        public void executeAsync() {
            ...
            new Thread(new Runnable() {
                ...
                // Checks if there are other actions with same id in the execution queue
                    if (RainbowActionsManager.BaseAction.ConcurrencyType.SingleInstance == getConcurrencyType()) {
